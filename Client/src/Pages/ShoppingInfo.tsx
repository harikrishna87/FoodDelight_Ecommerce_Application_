...
const ShoppingInfo: React.FC = () => {
  ...
  const paymentMethods = [
    ...
    { icon: <GiftOutlined />, method: 'Gift Cards', description: 'Use your FoodDelights gift cards' }
  ];
          ...
          >
            ...
            <div style={{ padding: '0 8px' }}>
              <Alert
                ...
                description="At FoodDelights, we make it simple to enjoy delicious, fresh food. Order online, by phone, or visit us in person. We're committed to quality and convenience."
                type="info"
                      ...
                      <Col xs={24} sm={12}>
                        <Space>
                          ...
                          <div>
                            ...
                            <br />
                            <Text copyable>orders@fooddelights.com</Text>
                          </div>
                        </Space>
                      </Col>
                      <Col xs={24} sm={12}>
                      ...
                      <Col xs={24} sm={12}>
                        <Space>
                          ...
                          <div>
                            ...
                            <br />
                            <Text copyable>www.FoodDelights.com</Text>
                          </div>
                        </Space>
                      </Col>
                    </Row>
