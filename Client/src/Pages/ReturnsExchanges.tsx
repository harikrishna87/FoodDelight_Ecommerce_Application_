          ...
          >
            ...
            <div style={{ padding: '0 8px' }}>
              <Alert
                ...
                description="At FoodDelights, we stand behind every meal we serve. If you're not completely satisfied, we'll make it right with a full refund or replacement."
                type="success"
                      ...
                      <Col xs={24} sm={12}>
                        <Space>
                          ...
                          <div>
                            ...
                            <br />
                            <Text copyable strong>returns@fooddelights.com</Text>
                          </div>
                        </Space>
                      </Col>
                      <Col xs={24} sm={12}>
